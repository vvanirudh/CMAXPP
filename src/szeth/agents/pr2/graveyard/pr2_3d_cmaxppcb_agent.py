...
class pr2_3d_cmaxppcb_agent(pr2_3d_agent):
    ...
    def learn_online_in_real_world(self):
        ...
        while True:
            ...
            self.update_buffer_qvalues(cb=True)
