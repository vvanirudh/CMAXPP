...
from ..utils import matrix_from_quat, point_from_pose, quat_from_pose, quat_from_matrix, \
    get_joint_limits, get_joint_position, get_joint_positions, get_distance, get_joint_name, get_joint_names
...
def select_solution(body, joints, solutions, nearby_conf=USE_ALL,
                    **kwargs):
    if not solutions:
        return None
